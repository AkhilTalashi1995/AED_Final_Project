...
public class RequestMeditationInstructorJPanel extends javax.swing.JPanel {
    ...
    public RequestMeditationInstructorJPanel(JPanel userProcessContainer, User account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, -1, 30));
        ...
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 160, 110, 30));

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Appointment Details");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 250, 220, 40));
        ...
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 250, 330, 40));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 110, 30));

        requestTestJButton.setBackground(new java.awt.Color(0, 153, 153));
        requestTestJButton.setFont(new java.awt.Font("Helvetica Neue", 1, 16)); // NOI18N
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 360, 210, 40));

        image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/house_cleaning.png"))); // NOI18N
        add(image, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 550, 410, 210));

        jLabel3.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Minfulness Appointment Booking");
    ...
    private void requestTestJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButtonActionPerformed
        ...
        if (!message.isEmpty()) {
            MeditationCoachWorkRequest request = new MeditationCoachWorkRequest();
            ...
            if (sourceNetwork != targetNetwork) {
                for (Enterprise enterprise : targetNetwork.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof OrganizationMeditation) {
                            org = organization;
                            break;
                        }
                    }
