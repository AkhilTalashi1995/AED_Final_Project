 ...
 * @author Aashay
 */
public class RequestGymTrainerJPanel extends javax.swing.JPanel {
    ...
    public RequestGymTrainerJPanel(JPanel userProcessContainer, User account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 160, -1, 30));

        valueLabel.setForeground(new java.awt.Color(0, 153, 153));
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 160, 190, 30));

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Appointment Details");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 190, 40));
        ...
        add(messageJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 250, 340, 40));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 110, 30));
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, 230, 40));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/logo-transparent-png (1).png"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 500, 420, 230));

        jLabel3.setFont(new java.awt.Font("Helvetica Neue", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Cross Fit Appointment Booking");
            ...
            if (sourceNetwork != targetNetwork) {
                for (Enterprise enterprise : targetNetwork.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof OrganizationGymnasium) {
                            org = organization;
                            break;
                        }
                    }
